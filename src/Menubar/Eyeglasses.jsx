  ...
  return (
    <div className="flex flex-col lg:flex-row lg:gap-24 px-4 sm:px-6 mt-16">
      ...
      <div className="flex-1 lg:mt-16 mt-8">
        <h1 className="text-2xl lg:text-3xl">Eyeglasses</h1>
        <p className="mt-4 text-sm lg:text-base">
          Eyeglasses, also known as glasses or spectacles, are vision eyewear
          that corrects or enhances vision. They consist of lenses mounted in a
          frame that holds them in front of the eyes, typically utilizing a
          bridge over the nose and hinged arms (temples or temple pieces) that
          rest over the ears for support.
        </p>
        <p className="mt-4 text-gray-600 text-sm lg:text-base">10 Products</p>
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          ...
          <Link to="/eyeg1">
            <div className="bg-gray-100 rounded-lg overflow-hidden aspect-[4/3] relative group">
              ...
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTk8Ro60qrLbhQQ_f5XlIwsAjZVTgNrWVM_-w&s"
                alt="Focus product"
          ...
          <Link to="/eyeg2">
            <div className="bg-gray-100 rounded-lg overflow-hidden aspect-[4/3] relative group">
              ...
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS_DcO8sDYZdwWdalesDjobHczgLlSscBlINg&s"
                alt="Nebula product"
                className="w-full h-full object-contain transition-transform duration-300 group-hover:scale-110"
              />
              <div className="absolute bottom-2 left-2 text-sm lg:text-base">
